...
if __name__ == '__main__':
    ...
    datasets = ['mlqa', 'mlqa', 'mlqa', 'arabic_squad', 'rusquad', 'zhsquad']
    ...
    for dataset, code, language in zip(datasets, lang_code, languages):
        ...
        publish_to_hf(f'{dataset}_{code}_adapter_100k',
                f'../results/qa/{dataset}_{code}_adapter_100k/{dataset}')
        ...
        publish_to_hf(f'{dataset}_{code}_prompt_100k',
                      f'../results/qa/{dataset}_{code}_prompt_100k/{dataset}_prompt')
        ...
        publish_to_hf(f'{language}_adapter_{dataset}_adapter_100k',
                      f'../results/qa/{language}_adapter_{dataset}_adapter_100k/{dataset}')
        ...
        publish_to_hf(f'{language}_adapter_{dataset}_prompt_100k',
                      f'../results/qa/{language}_adapter_{dataset}_prompt_100k/{dataset}_prompt')
        ...
        publish_to_hf(f'{language}_prompt_{dataset}_adapter_100k',
                      f'../results/qa/{language}_prompt_{dataset}_adapter_100k/{dataset}')
        ...
        publish_to_hf(f'{language}_prompt_{dataset}_prompt_100k',
                      f'../results/qa/{language}_prompt_{dataset}_prompt_100k/{dataset}_prompt')
