...
if __name__ == '__main__':
    ...
    for dataset, code, language in zip(datasets, lang_code, languages):
        ...
        publish_to_hf(f'{dataset}_{code}_adapter_100k',
                      f'../results/checkworthy/{dataset}_{code}_adapter_100k/{dataset}')
        ...
        publish_to_hf(f'{dataset}_{code}_prompt_100k',
                      f'../results/checkworthy/{dataset}_{code}_prompt_100k/{dataset}_prompt')
        ...
        publish_to_hf(f'{language}_adapter_{dataset}_adapter_100k',
                      f'../results/checkworthy/{language}_adapter_{dataset}_adapter_100k/{dataset}')
        ...
        publish_to_hf(f'{language}_adapter_{dataset}_prompt_100k',
                      f'../results/checkworthy/{language}_adapter_{dataset}_prompt_100k/{dataset}_prompt')
        ...
        publish_to_hf(f'{language}_prompt_{dataset}_adapter_100k',
                      f'../results/checkworthy/{language}_prompt_{dataset}_adapter_100k/{dataset}')
        ...
        publish_to_hf(f'{language}_prompt_{dataset}_prompt_100k',
                      f'../results/checkworthy/{language}_prompt_{dataset}_prompt_100k/{dataset}_prompt')
